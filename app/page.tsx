...
export default function Home() {
  ...
  const generatePdf = async () => {
    ...
    try {
      ...
      const maxSide = jpegQuality >= 0.98 ? 5200 : jpegQuality >= 0.88 ? 3600 : 2400;
        ...
        <section className="editor">
          ...
          <div className="settings-card">
            ...
            <div className="setting-grid">
              ...
              <label><span>圖片畫質</span><select value={quality} onChange={(event) => setQuality(event.target.value)}><option value="0.78">精簡檔案</option><option value="0.9">平衡（建議）</option><option value="1">最高畫質</option></select></label>
            </div>
